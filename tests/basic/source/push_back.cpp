...
inline namespace ztd_static_containers_tests_basic_push_back {
	template <typename Container>
	constexpr auto make_static_containers(std::size_t elements) {
...
} // namespace ztd_static_containers_tests_basic_push_back

TEMPLATE_LIST_TEST_CASE(
     "static_vector push_back tests", "[static_vector][run_time][push_back]", ztd::tests::scalar_types_list) {
