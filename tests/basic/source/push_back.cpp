...
inline namespace ztd_inline_containers_tests_basic_push_back {
...
} // namespace ztd_inline_containers_tests_basic_push_back

TEMPLATE_LIST_TEST_CASE(
     "inline_vector push_back tests", "[inline_vector][run_time][push_back]", ztd::tests::scalar_types_list) {
