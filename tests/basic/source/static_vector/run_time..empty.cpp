...
TEMPLATE_LIST_TEST_CASE("static_vector with an empty with capacity using compile-time capable scalar types",
     "[static_vector][run_time][empty]", ztd::tests::scalar_types_list) {
	constexpr std::size_t Capacity = 5;
	ztd::static_vector<TestType, Capacity> c {};
